...
#
# LightGBM Benchmark (No Leakage Version)
#
# Dataset:
...
#
# Benchmark dataset (800,000 rows)
# Elimination of variables with targeted leakage
# Elimination of current-week epidemiology
# Only numeric variables
# float32
# Imputation by median within each fold
# Time validation with expanding window
# More conservative LightGBM (200 trees, 15 leaves)
# Excel, CSV, PNG, and Markdown report
# Separate folder: DENGUE_BRASIL/BENCHMARK/LIGHTGBM_V3_FORECASTING
# ============================================================
...
plt.title(
    "LightGBM Feature Importance (No Leakage)"
)
